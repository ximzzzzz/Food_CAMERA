...
class ResNet(nn.Module):
    ...
    def __init__(self, input_channel, output_channel, block, layers):
        ...
        self.bn2 = nn.BatchNorm2d(self.output_channel_blocko[1])
        
        self.maxpool3 = nn.MaxPool2d(kernel_size=2, stride=2, padding=0)
        self.layer3 = self._make_layer(block, self.output_channel_block[2], layer[2], stride=1)
        ...
        self.conv4_2 nn.Conv2d(self.output_channel_block[3], output_channel_block[3], kernel_size=2, stride=1, padding=0, bias=False)
    ...
    def _make_layer(self, block, planes, blocks, stride=1):
        ...
        self.inplnes = planes * block.expansion
